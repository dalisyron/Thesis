...
\label{sec:optim}
در این قسمت دو بهینه‌سازی مختلف را به منظور بهبود عملکرد الگوریتم \ref{alg:cap} معرفی می‌کنیم.
...
$\eta_0, \cdots, \eta_k$
را به یک هسته/گره پردازشی خاص اختصاص داد. این بهینه‌سازی در فریم‌ورک \lr{Kompute} پیاده‌سازی شده است و هنگام اجرا بر روی سرور ابرآروان با ۲۴ هسته و تقسیم‌بندی به ۲۴ رشته\LTRfootnote{Thread} عملکردی معادل ۲۰ برابر سریع‌تر از حالت تک‌رشته\LTRfootnote{Single-thread} داشت.
\newpage
