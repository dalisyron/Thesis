...
\begin{figure}
	...
	\caption{مولفه‌های شرکت‌کننده در حل مسئله خطی استراتژی تخلیه در \lr{Kompute}}
	\label{fig:solverdiagram}
\end{figure}
\newpage
\section{تعریف و حل یک مسئله تخلیه‌ی وظیفه نمونه در \lr{Kompute}}
در قطعه کد نمونه زیر، مسئله تخلیه‌ی وظیفه‌ برای محیط رایانش لبه‌ای با دو صف\footnote{شرایط بر اساس تقسیم‌بندی وظایف به \lr{Heavy} و \lr{Light} در اینترنت اشیاء} حل شده است.
\begin{LTR}
...
\newpage
\section{شبیه‌سازی استراتژی‌های تخلیه‌ی وظیفه}
