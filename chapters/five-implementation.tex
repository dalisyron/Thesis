...
\end{figure}
\newpage
\section{تعریف و حل یک مسئله تخلیه وظیفه نمونه در \lr{Kompute}}
در قطعه کد نمونه زیر، مسئله تخلیه وظیفه‌ برای محیط رایانش لبه‌ای با دو صف\footnote{شرایط بر اساس تقسیم‌بندی وظایف به \lr{Heavy} و \lr{Light} در اینترنت اشیا} حل شده است.
\begin{LTR}
...
\newpage
\section{شبیه‌سازی استراتژی‌های تخلیه وظیفه}
